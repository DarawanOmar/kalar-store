...
const column: ColumnDef<{
  ...
  },
  {
    ...
    cell: function CellComponent({ row }) {
      ...
      const salePrice = row?.original?.sale_price || 0;
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="space-y-1" align="end">
              ...
              <CustomDialog
                ...
                button={
                  <button className="flex gap-2 items-center fonts-sirwan_reguler  hover:bg-primary hover:text-white transition-all duration-500 p-2 rounded-lg w-full">
